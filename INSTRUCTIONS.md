...
- `stylelint:fix`: start stylelint check and fix errors for CSS, SCSS files.
...
- `pnpm husky`: installs and configures Husky, automatically sets up Git hooks after pnpm install.
